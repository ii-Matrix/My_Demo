 ...
 * 定义 KEY 编号对应的管脚
 */
//PTXn_e KEY_PTxn[KEY_MAX] = {PTC17, PTD10, PTC16, PTC14, PTD11, PTD12, PTB23, PTE10,PTC1};
PTXn_e KEY_PTxn[KEY_MAX] = {PTA29, PTB8, PTA28, PTA26,  PTB9, PTD12,PTD13,PTD14, PTD15};
